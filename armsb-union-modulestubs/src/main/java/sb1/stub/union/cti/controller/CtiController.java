package sb1.stub.union.cti.controller;


import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.*;
import sb1.stub.union.cti.data.Jsons;
...
public class CtiController {
    ...
    public String setDelta(@PathVariable String delta) {
        CtiController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + CtiController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + CtiController.delta + "\n";
    }
}