package ru.company.mock2.dummy.webservice;

import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.io.IOUtils;
import org.springframework.web.bind.annotation.*;
import ru.company.mock2.dummy.data.hardcode.Jsons;
...
public class Mock2WebController {
    ...
    public String setDelta(@PathVariable String delta) {
        Mock2WebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + Mock2WebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + Mock2WebController.delta + "\n";
    }
}
