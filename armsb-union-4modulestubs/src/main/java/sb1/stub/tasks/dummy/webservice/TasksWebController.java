package sb1.stub.tasks.dummy.webservice;
...
import sb1.stub.tasks.dummy.data.hardcode.Jsons;
...
public class TasksWebController {
    ...
    public String setDelta(@PathVariable String delta) {
        TasksWebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + TasksWebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + TasksWebController.delta + "\n";
    }
}
