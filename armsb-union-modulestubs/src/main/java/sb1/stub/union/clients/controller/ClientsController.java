package sb1.stub.union.clients.controller;
...
import sb1.stub.union.clients.data.Jsons;
...
public class ClientsController {
    ...
    public String setDelta(@PathVariable String delta) {
        ClientsController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + ClientsController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + ClientsController.delta + "\n";
    }
}