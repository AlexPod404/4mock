package ru.company.mock1.dummy.webservice;
...
import ru.company.mock1.dummy.data.hardcode.Jsons;
...
public class Mock1WebController {
    ...
    public String setDelta(@PathVariable String delta) {
        Mock1WebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + Mock1WebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + Mock1WebController.delta + "\n";
    }
}
