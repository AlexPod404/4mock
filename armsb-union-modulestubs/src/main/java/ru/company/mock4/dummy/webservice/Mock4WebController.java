package ru.company.mock4.dummy.webservice;
...
import ru.company.mock4.dummy.data.hardcode.Jsons;
...
@Slf4j
@RestController
@RequestMapping("/mock4")
public class Mock4WebController {
    ...
    public String setDelta(@PathVariable String delta) {
        Mock4WebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + Mock4WebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + Mock4WebController.delta + "\n";
    }
}
