package sb1.stub.union.tasks.controller;
...
import sb1.stub.union.tasks.data.Jsons;
...
public class TasksController {
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/clients/getByTeamId", produces = "application/json")
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/clients/get", produces = "application/json")
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/getByFilter", produces = "application/json")
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/getTaskById", produces = "application/json")
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/getFilters", produces = "application/json")
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/marking/getById", produces = "application/json")
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/data-dictionary-service/rest/pm/ver.4.0/getRows", produces = "application/json")
    ...
    public String tasks(@RequestBody String newJsonBody) {
        String respText = "";
    ...
    public String tasksTeamsGet(@RequestBody String newJsonBody) {
        String respText = "";
        String requestText = newJsonBody;
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/marking/check", produces = "application/json")
    public String tasksMarkingCheck(@RequestBody String newJsonBody) {
        String respText = "";
        String requestText = newJsonBody;
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/teams/free", produces = "application/json")
    public String tasksTeamsFree(@RequestBody String newJsonBody) {
        String requestText = newJsonBody;
        Thread.sleep(delta);
     ...
     */
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/marking/getByClient", produces = "application/json")
    public String tasksMarkingGetByClient(@RequestBody String newJsonBody) {
        String respText = "";
        String requestText = newJsonBody;
        if (requestText.length() == 0) {
            respText = Jsons.errorRequest();
    ...
    public String setDelta(@PathVariable String delta) {
        TasksController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + TasksController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + TasksController.delta + "\n";
    }
}