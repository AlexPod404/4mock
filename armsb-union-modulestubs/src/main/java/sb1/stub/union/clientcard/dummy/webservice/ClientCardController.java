package sb1.stub.union.clientcard.dummy.webservice;

import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.io.IOUtils;
import org.springframework.web.bind.annotation.*;
import sb1.stub.union.clientcard.dummy.data.hardcode.Jsons;
...
public class ClientCardController {
    ...
    public String setDelta(@PathVariable String delta) {
        ClientCardController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + ClientCardController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + ClientCardController.delta + "\n";
    }
}
