package sb1.stub.clients.dummy.webservice;
...
import sb1.stub.clients.dummy.data.hardcode.Jsons;
...
public class ClientsWebController {
    ...
    @RequestMapping(value = "/srvgetclientlist", produces = "application/json")
    ...
    //createContext  - 1 - clients/srvgetclientlist
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/armsb/v1/rest/getClientsForMassMailing", produces = "application/json")
    ...
    //createContext  - 1 - clients/srvgetclientlist
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/srvgetclientlist/clients/searchByLastName", produces = "application/json")
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/pprbBhepService", produces = "application/json")
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/pprbClients/clients/getByTeamId", produces = "application/json")
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/ucpclients/clients/get", produces = "application/json")
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/pprbClients", produces = "application/json")
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/ucpclients", produces = "application/json")
    ...
    public String setDelta(@PathVariable String delta) {
        ClientsWebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + ClientsWebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + ClientsWebController.delta + "\n";
    }
}
