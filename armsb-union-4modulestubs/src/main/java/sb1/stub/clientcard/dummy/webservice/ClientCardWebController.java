package sb1.stub.clientcard.dummy.webservice;

import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.io.IOUtils;
import org.springframework.web.bind.annotation.*;
import sb1.stub.clientcard.dummy.data.hardcode.Jsons;
...
public class ClientCardWebController {
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/getClientCardFromCRMandEPK/rest/v1/context", produces = "application/json")
    ...
    @SneakyThrows(Exception.class)
    @RequestMapping(value = "/getClientCardFromCRMandEPK", produces = "application/json")
    ...
    public String setDelta(@PathVariable String delta) {
        ClientCardWebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + ClientCardWebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + ClientCardWebController.delta + "\n";
    }
}
