package ru.company.mock3.dummy.webservice;


import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.*;
import ru.company.mock3.dummy.data.hardcode.Jsons;

@Slf4j
@RestController
@RequestMapping("/mock3")
public class Mock3WebController {
    ...
    public String setDelta(@PathVariable String delta) {
        Mock3WebController.delta = Long.parseLong(delta, 10);
        return "Set delta to: " + Mock3WebController.delta + "\n";
    }

    @RequestMapping(value = "/getDelta", method = RequestMethod.GET)
    @ResponseBody
    public String getDelta() {
        return "Delta is: " + Mock3WebController.delta + "\n";
    }
}
